    ...
    <React.Fragment>
      <section id="about">
        <div className="flex flex--center">
          ...
          <div className="col-1">
            <p>
              COL-2 Lorem ipsum dolor sit amet, consectetur adipiscing elit.
              Morbi non consectetur diam, et dignissim erat. Integer
              pellentesque sed justo eget mollis. Pellentesque ac orci vel dolor
              aliquet facilisis. Etiam malesuada metus arcu, ac pharetra ex
              semper id. Nunc porttitor lorem in sodales accumsan. In congue
              placerat magna, vel accumsan risus rhoncus eu. Mauris egestas,
              magna at iaculis ultrices, nibh eros tristique purus, nec pulvinar
              lorem augue eget leo. Ut eros risus, vulputate eu mauris sit amet,
              feugiat dapibus elit.
            </p>
          </div>
        </div>
